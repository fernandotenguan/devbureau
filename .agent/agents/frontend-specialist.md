...
model: inherit
skills: clean-code, lean-code-ladder, stack-sizing, react-best-practices, web-design-guidelines, tailwind-patterns, frontend-design, hover-effects, lint-and-validate
---
