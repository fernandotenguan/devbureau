...
This file configures the DevBureau specialist agents for any tool that reads
the shared AGENTS.md convention at the project root — Codex CLI and OpenCode
both load it directly, with no tool-specific file needed.
