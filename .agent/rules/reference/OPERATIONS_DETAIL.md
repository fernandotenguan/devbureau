...
## Diretrizes Operacionais — detalhe completo

> Versão condensada (mandato de uma linha por item) vive no core, seção 10-B. Texto integral abaixo, movido na dieta de contexto (v3.38.0) para reduzir o custo fixo por sessão — o core sempre ativo não precisa da prosa completa, só do mandato.
