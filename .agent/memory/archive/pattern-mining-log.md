# pattern-mining-log — archive

> Entries rotated out of `.agent/memory/pattern-mining-log.md` by `memory_rotate.py` to keep the active file under 50 KB. Nothing was deleted; `memory_recall.py` still searches this file.
