...
1. **Recon** — read README/CLAUDE.md/AGENTS.md, config, CI, conventions, exact build/test/lint commands, git churn.
...
3. **Vet** — re-read every cited `file:line` yourself before it reaches the table. Reject by-design behavior, fix mis-attributions, drop duplicates.
