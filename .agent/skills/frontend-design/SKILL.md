...
description: Use when designing pages, improving visual appearance, choosing colors, changing layout, or making things look better — design thinking and decision-making for web UI. Also triggers on "melhorar o visual", "mudar as cores", "redesign", "tá feio", "quero mais bonito", "interface premium", or "design moderno".
