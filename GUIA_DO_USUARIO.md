...
| Comando | Quando Usar | O que Faz |
|---------|-------------|-----------|
| `checar kit` | Antes de qualquer trabalho importante | Diagnóstico completo do kit (22 agentes, 59 skills) |
...
O agente vai rodar `doctor.py` e confirmar que todos os 22 agentes, 59 skills e 19 workflows estão funcionando corretamente.
